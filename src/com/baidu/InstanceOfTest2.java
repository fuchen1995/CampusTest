...
class Employee {
	...
	public  boolean equals(Object obj) {
		...
		if (obj == null)
			return false;
//		if (!(obj instanceof Employee)) //apogee是Employee的一个子类  所以instanceof会返回true
...
public class InstanceOfTest2 {
	...
	public static void main(String[] args){
		...
		Manager boss = new Manager("bob", 5000);
		boss.setBonus(5000);
		
		System.out.println(carl.equals(boss)); //flase
		
		System.out.println(bob.equals(boss));
		System.out.println(boss.equals(bob));
	}
